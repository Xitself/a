...
Announce_Label.Text = loadstring(game:HttpGet("https://raw.githubusercontent.com/raditself/a/main/announce"))()
...
OpenClose.Image = "rbxassetid://72480469437554"
...
AntiFling_Button.MouseButton1Click:Connect(function()
	...
	if AntiFling_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		...
		loadstring(game:HttpGet('https://raw.githubusercontent.com/raditself/a/main/Antifling'))()
	else
		_G.AntiFlingToggled = false
	end
end)
...
FreeEmotes_Button.MouseButton1Click:Connect(function()
	if not FreeEmotesEnabled then
		...
		loadstring(game:HttpGet("https://raw.githubusercontent.com/raditself/a/main/emotes"))()
	end
end)
...
task.spawn(function()
	while task.wait(10) do
		pcall(function()
			local GuiVersion = loadstring(game:HttpGet("https://raw.githubusercontent.com/raditself/a/main/version"))()
